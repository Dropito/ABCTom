...
const DRAW = {
  ...
  '🔍': (k) => k.bar(62, 62, 88, 88, 16, '#8a4a2a') + k.c(88, 88, 8, '#8a4a2a') +
    k.pe('M42 6 A36 36 0 1 1 41.9 6Z M42 18 A24 24 0 1 0 42.1 18Z', k.G('gold')) +
    k.c(42, 42, 24, k.lg(['#e8fbff', '#8ad8ff'], 'd'), 0.85) + k.p('M28 32 Q34 22 46 22 Q36 26 32 36Z', '#ffffff'),
